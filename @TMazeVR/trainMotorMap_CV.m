function obj = trainMotorMap_CV(obj, iPlane, iROI, options)
...
[theMap, binCentres] = estMap(cell2mat(coords), cell2mat(fVector), {vEdges, rEdges}, hFilter);
hFilter = ndGaussian([0.2 0.2]);
[rawMap, ~] = estMap(cell2mat(coords), cell2mat(fVector), {vEdges, rEdges}, hFilter);
