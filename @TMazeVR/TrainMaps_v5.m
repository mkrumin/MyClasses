function TrainMaps_v5(obj, iPlane, iROI, options)

% v5 of TrainMaps - trying to solve the 'non-decaying estimates' problem of
% sharp events (usually ahappening towards the end of the T-Maze)
