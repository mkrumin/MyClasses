...
dThEdges = buildEdges([dThMin dThMax], options.dTheta);
...
[theMap, binCentres] = estMap(cell2mat(coords), cell2mat(fVector), {dZEdges, dThEdges}, hFilter);
hFilter = ndGaussian([0.2 0.2]);
[rawMap, ~] = estMap(cell2mat(coords), cell2mat(fVector), {dZEdges, dThEdges}, hFilter);
